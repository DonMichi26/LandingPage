            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up"
                ...
                <button
                  ...
                  className="group inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-xl border border-white/10 text-sm font-medium text-white/70 hover:bg-white/5 hover:border-white/20 hover:text-white transition-all"
                >
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className={`p-5 rounded-2xl card-dark border border-[var(--color-border)] ${index === 0 ? 'col-span-2' : ''}`}
                  >
