...
export function StickyCta() {
  ...
  return (
    ...
    >
      ...
      <span className="whitespace-nowrap overflow-hidden max-w-0 md:group-hover:max-w-[160px] md:group-hover:opacity-100 max-md:max-w-[160px] max-md:opacity-100 transition-all duration-300 text-sm font-semibold">
